# Generated by Django 3.0.8 on 2020-09-12 04:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codeAg', models.CharField(max_length=100)),
                ('numberAg', models.BigIntegerField()),
                ('descriptionAg', models.TextField()),
                ('dateAg', models.DateField()),
                ('typeAgreement', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='budgets.TypeAgreement')),
            ],
        ),
        migrations.AddField(
